...
import { createEditorialCoverage, formatEditorialCoverage } from '../site/content/coverage.js'
...
console.log(`\n${formatEditorialCoverage(createEditorialCoverage(editorialResources))}`)
